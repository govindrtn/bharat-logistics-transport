...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full bg-[#20b75a] p-4 font-extrabold text-white shadow-2xl transition hover:-translate-y-1 sm:px-5"
    >
